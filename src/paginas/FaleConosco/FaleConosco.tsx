...
export default function FaleConosco(){
    ...
    function sendEmail(e:any): void{
        e.preventDefault();
        emailjs.sendForm ('DandaraGmail', 'DandaraTemplate', e.target, 'user_fznK95vdp57aJoomPqOBT').then((result)=>
        {alert("Mensagem enviada com sucesso.");},(error)=>{alert(error.message)});
        e.target.reset()
    }
    return (
        <>
